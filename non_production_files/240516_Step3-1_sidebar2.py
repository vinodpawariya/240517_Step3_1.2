...
st.write(f'賃料　　　　{rent_price_min_formatted}万円～{rent_price_max_formatted}万円') #これらはサイドバーじゃないほうが見やすい？
...
exclusive_area = st.sidebar.slider("専有面積（㎡）",
...
minutes_on_foot = st.sidebar.slider("駅徒歩（分）",
...
# streamlit run 240516_Step3-1_sidebar.py